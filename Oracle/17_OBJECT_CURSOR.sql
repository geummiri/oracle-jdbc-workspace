/*
    커서(CURSOR)
    -SQL구문의 처리 결과를 담고 있는 객체
    -여러행으로 나타난 처리 결과를 순차적으로 접근 가능
    ...
    *종류
    ...
    2.명시적(explicit)커서
        ...
        *커서 속성
        ...
        커서명%ROWCOUNT : SQL처리 결과로 얻어온 행(ROW)의 수
*/
--1. 묵시적 커서
SET SERVEROUTPUT ON;
...
/
--명시적커서 예시
--전체 부서에 대해 부서코드, 부서명,지역조회(CURSOR와 PL/SQL 사용)
DECLARE
